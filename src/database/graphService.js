const { getSession } = require("./neo4jClient");

async function getFriendsByClientId(idCliente) {
...
async function getAllClientsWithFriends() {
  const session = await getSession();
...
module.exports = { getFriendsByClientId, getAllClientsWithFriends };
